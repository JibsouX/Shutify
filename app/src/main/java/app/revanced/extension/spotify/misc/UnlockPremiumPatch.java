...
public final class UnlockPremiumPatch {
    ...
    private static final List<OverrideAttribute> PREMIUM_OVERRIDES = List.of(
        new OverrideAttribute("streaming", TRUE, false),
        new OverrideAttribute("pick-and-shuffle", FALSE, false),
        ...
        new OverrideAttribute("shuffle", FALSE, false),
        new OverrideAttribute("ad-formats-preroll-video", FALSE, false),
        new OverrideAttribute("ad-session-persistence", FALSE, false),
        new OverrideAttribute("is-eligible-premium-unboxing", TRUE, false),
        new OverrideAttribute("premium-unboxing-auto-open", TRUE, false),
        new OverrideAttribute("ab-ad-player-targeting", FALSE, false),
        new OverrideAttribute("allow-advertising-id-transmission", FALSE, false),
